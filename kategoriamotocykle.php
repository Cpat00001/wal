...
<head>
    ...
    <title>Nauka jazdy motory Wałbrzych.Kategoria A, A2, AM , A1 w Wałbrzychu.</title>
    <meta name="robots" content="index,fallow">
    <meta charset="UTF-8">
    <meta name="description" content="Nauka jazdy kategoria A , A2, AM ,A1 w Wałbrzychu. Kursy Prawa Jazdy na motory  Wałbrzych.">
    <meta name="keywords" content="nauka jazdy motory Wałbrzych , prawo jazdy, kategoria A A2 AM A1, 
        Wałbrzych, egzamin kategoria A Wałbrzych, nauka jazdy motory, nauka jazdy motory Wałbrzych, kursy motocyklowe, kategoria A, kategoria prawo jazdy A2, kategoria A1">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Bootstrap4 -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <link rel="stylesheet" href="./stylingwalbrzych/motorywalbrzych.css">
    ...
    <div class="container">
        <div class="row" id="row1">
            <div class="col-sm-12 col-md-6">
                <h1>Nauka Jazdy Motorami Wałbrzych <span style="color:red;font-size:45px;font-weight:bold">Wiraż</span></h1>
                <h5 style="margin-top:10%;">motocyklowe prawa jazdy:</h5><br>
                <h3>Wałbrzych kategorie A, A2, AM , A1</h3>
            </div>
            <div class="col-sm-12 col-md-6">
                <br><br>
        ...
        <div class="row" id="row2">
            ...
            <div class="col-sm-12 col-md-3" id="karta">
                <a href="../nauka_jazdy_motor/kategoria_A1.php">
                    <h5>kategoria A1</h5>
